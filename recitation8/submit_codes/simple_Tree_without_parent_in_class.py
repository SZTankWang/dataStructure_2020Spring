...
leftSubTree = TreeWithoutParent('*', TreeWithoutParent(3),TreeWithoutParent(2))
rightSubTree = TreeWithoutParent('-',TreeWithoutParent(5),TreeWithoutParent(2))
tree = TreeWithoutParent('+',leftSubTree, rightSubTree)
## to do
